...
DP4 R0.x, R1, c[13];
DP4 R0.y, R1, c[14];
MAD result.texcoord[2].xyz, R0, c[6].w, -vertex.position;
...
Bind "normal" Normal
Bind "texcoord" TexCoord0
ConstBuffer "$Globals" 144 // 80 used size, 6 vars
...
"vs_4_0
eefiecedfcpeejejfaghglfdckhhpngimjnecniaabaaaaaaleaeaaaaadaaaaaa
...
aaaaaaaadgaaaaafdccabaaaabaaaaaaegbabaaaacaaaaaadiaaaaajhcaabaaa
...
egbcbaiaebaaaaaaaaaaaaaadgaaaaafhccabaaaadaaaaaaegbcbaaaabaaaaaa
...
void main ()
{
  ...
  normal_4 = xlv_TEXCOORD1;
  highp float tmpvar_7;
  tmpvar_7 = clamp (dot (normal_4, normalize(xlv_TEXCOORD2)), 0.0, 1.0);
  diff_3 = tmpvar_7;
  c_2.xyz = (((tmpvar_6.xyz * _LightColor0.xyz) * diff_3) * (texture2D (_LightTexture0, vec2(tmpvar_5)).w * 2.0));
  c_2.w = tmpvar_6.w;
  tmpvar_1 = c_2;
...
bdaaaaaaacaaaeacbeaaaaoeabaaaaaaaaaaaaoeacaaaaaa dp4 r2.z, c20, r0
aaaaaaaaaaaaapacanaaaaoeabaaaaaaaaaaaaaaaaaaaaaa mov r0, c13
bdaaaaaaacaaacacbeaaaaoeabaaaaaaaaaaaaoeacaaaaaa dp4 r2.y, c20, r0
aaaaaaaaabaaapacamaaaaoeabaaaaaaaaaaaaaaaaaaaaaa mov r1, c12
bdaaaaaaacaaabacbeaaaaoeabaaaaaaabaaaaoeacaaaaaa dp4 r2.x, c20, r1
...
adaaaaaaabaaahacacaaaakeacaaaaaabfaaaappabaaaaaa mul r1.xyz, r2.xyzz, c21.w
acaaaaaaacaaahaeabaaaakeacaaaaaaaaaaaaoeaaaaaaaa sub v2.xyz, r1.xyzz, a0
bdaaaaaaadaaaeaeaaaaaaoeacaaaaaabcaaaaoeabaaaaaa dp4 v3.z, r0, c18
bdaaaaaaadaaacaeaaaaaaoeacaaaaaabbaaaaoeabaaaaaa dp4 v3.y, r0, c17
bdaaaaaaadaaabaeaaaaaaoeacaaaaaabaaaaaoeabaaaaaa dp4 v3.x, r0, c16
...
// FLOW 1 static, 0 dynamic
"vs_4_0_level_9_1
eefiecedbpfljjjcdnokpddcjcgbedlcccbpamgeabaaaaaammagaaaaaeaaaaaa
daaaaaaaeeacaaaaliafaaaacmagaaaaebgpgodjamacaaaaamacaaaaaaacpopp
...
aaaaammaaaaaoeiaabaaaaacaaaaadoaacaaoejaabaaaaacacaaahoaabaaoeja
...
egaobaaaaaaaaaaadgaaaaafdccabaaaabaaaaaaegbabaaaacaaaaaadiaaaaaj
...
aeaaaaaapgapbaaaaaaaaaaaegacbaaaaaaaaaaadoaaaaabejfdeheogmaaaaaa
...
// FLOW 1 static, 0 dynamic
"vs_4_0
eefiecedloaehpmdjhkkfocgehaglgkekdefbfbjabaaaaaaceadaaaaadaaaaaa
...
acaaaaaadiaaaaajhcaabaaaaaaaaaaafgifcaaaaaaaaaaaaaaaaaaaegiccaaa
...
void main ()
{
  ...
  normal_4 = xlv_TEXCOORD1;
  highp float tmpvar_6;
  tmpvar_6 = clamp (dot (normal_4, normalize(xlv_TEXCOORD2)), 0.0, 1.0);
  diff_3 = tmpvar_6;
  c_2.xyz = (((tmpvar_5.xyz * _LightColor0.xyz) * diff_3) * 2.0);
  c_2.w = tmpvar_5.w;
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
[bc]
aaaaaaaaaaaaapacakaaaaoeabaaaaaaaaaaaaaaaaaaaaaa mov r0, c10
bdaaaaaaacaaaeaeamaaaaoeabaaaaaaaaaaaaoeacaaaaaa dp4 v2.z, c12, r0
aaaaaaaaaaaaapacajaaaaoeabaaaaaaaaaaaaaaaaaaaaaa mov r0, c9
aaaaaaaaabaaapacaiaaaaoeabaaaaaaaaaaaaaaaaaaaaaa mov r1, c8
bdaaaaaaacaaacaeamaaaaoeabaaaaaaaaaaaaoeacaaaaaa dp4 v2.y, c12, r0
bdaaaaaaacaaabaeamaaaaoeabaaaaaaabaaaaoeacaaaaaa dp4 v2.x, c12, r1
aaaaaaaaabaaahaeabaaaaoeaaaaaaaaaaaaaaaaaaaaaaaa mov v1.xyz, a1
aaaaaaaaaaaaadaeadaaaaoeaaaaaaaaaaaaaaaaaaaaaaaa mov v0.xy, a3
bdaaaaaaaaaaaiadaaaaaaoeaaaaaaaaahaaaaoeabaaaaaa dp4 o0.w, a0, c7
bdaaaaaaaaaaaeadaaaaaaoeaaaaaaaaagaaaaoeabaaaaaa dp4 o0.z, a0, c6
...
// FLOW 1 static, 0 dynamic
"vs_4_0_level_9_1
eefiecedhlkjofoijkbhkpljcjefdbegencaemknabaaaaaaieaeaaaaaeaaaaaa
daaaaaaaimabaaaaiiadaaaapmadaaaaebgpgodjfeabaaaafeabaaaaaaacpopp
...
aaaaoeiaabaaaaacaaaaammaaaaaoeiaabaaaaacaaaaadoaacaaoejaabaaaaac
acaaahoaabaaoejappppaaaafdeieefcpeabaaaaeaaaabaahnaaaaaafjaaaaae
...
egbabaaaacaaaaaadiaaaaajhcaabaaaaaaaaaaafgifcaaaaaaaaaaaaaaaaaaa
...
abaaaaaaahahaaaagaaaaaaaaaaaaaaaaaaaaaaaadaaaaaaacaaaaaaapadaaaa
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
void main ()
{
  ...
  highp float tmpvar_10;
  tmpvar_10 = ((float((xlv_TEXCOORD3.z > 0.0)) * tmpvar_6.w) * tmpvar_9.w);
  atten_5 = tmpvar_10;
  lowp vec4 tmpvar_11;
  tmpvar_11 = (texture2D (_MainTex, xlv_TEXCOORD0) * _Color);
  normal_4 = xlv_TEXCOORD1;
  highp float tmpvar_12;
  tmpvar_12 = clamp (dot (normal_4, normalize(xlv_TEXCOORD2)), 0.0, 1.0);
  diff_3 = tmpvar_12;
  c_2.xyz = (((tmpvar_11.xyz * _LightColor0.xyz) * diff_3) * (atten_5 * 2.0));
  c_2.w = tmpvar_11.w;
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
adaaaaaaabaaahacacaaaakeacaaaaaabfaaaappabaaaaaa mul r1.xyz, r2.xyzz, c21.w
acaaaaaaacaaahaeabaaaakeacaaaaaaaaaaaaoeaaaaaaaa sub v2.xyz, r1.xyzz, a0
bdaaaaaaadaaaiaeaaaaaaoeacaaaaaabdaaaaoeabaaaaaa dp4 v3.w, r0, c19
bdaaaaaaadaaaeaeaaaaaaoeacaaaaaabcaaaaoeabaaaaaa dp4 v3.z, r0, c18
bdaaaaaaadaaacaeaaaaaaoeacaaaaaabbaaaaoeabaaaaaa dp4 v3.y, r0, c17
bdaaaaaaadaaabaeaaaaaaoeacaaaaaabaaaaaoeabaaaaaa dp4 v3.x, r0, c16
aaaaaaaaabaaahaeabaaaaoeaaaaaaaaaaaaaaaaaaaaaaaa mov v1.xyz, a1
...
// FLOW 1 static, 0 dynamic
"vs_4_0_level_9_1

...

...
void main ()
{
  ...
  tmpvar_7 = clamp (dot (normal_4, normalize(xlv_TEXCOORD2)), 0.0, 1.0);
  diff_3 = tmpvar_7;
  c_2.xyz = (((tmpvar_6.xyz * _LightColor0.xyz) * diff_3) * ((texture2D (_LightTextureB0, vec2(tmpvar_5)).w * textureCube (_LightTexture0, xlv_TEXCOORD3).w) * 2.0));
  c_2.w = tmpvar_6.w;
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
egbabaaaacaaaaaadiaaaaajhcaabaaaaaaaaaaafgifcaaaabaaaaaaaaaaaaaa
...
void main ()
{
  ...
  tmpvar_6 = clamp (dot (normal_4, normalize(xlv_TEXCOORD2)), 0.0, 1.0);
  diff_3 = tmpvar_6;
  c_2.xyz = (((tmpvar_5.xyz * _LightColor0.xyz) * diff_3) * (texture2D (_LightTexture0, xlv_TEXCOORD3).w * 2.0));
  c_2.w = tmpvar_5.w;
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
[bc]
aaaaaaaaaaaaapacaoaaaaoeabaaaaaaaaaaaaaaaaaaaaaa mov r0, c14
bdaaaaaaacaaaeaebeaaaaoeabaaaaaaaaaaaaoeacaaaaaa dp4 v2.z, c20, r0
aaaaaaaaaaaaapacanaaaaoeabaaaaaaaaaaaaaaaaaaaaaa mov r0, c13
bdaaaaaaacaaacaebeaaaaoeabaaaaaaaaaaaaoeacaaaaaa dp4 v2.y, c20, r0
aaaaaaaaabaaapacamaaaaoeabaaaaaaaaaaaaaaaaaaaaaa mov r1, c12
bdaaaaaaaaaaaiacaaaaaaoeaaaaaaaaalaaaaoeabaaaaaa dp4 r0.w, a0, c11
bdaaaaaaaaaaaeacaaaaaaoeaaaaaaaaakaaaaoeabaaaaaa dp4 r0.z, a0, c10
bdaaaaaaaaaaabacaaaaaaoeaaaaaaaaaiaaaaoeabaaaaaa dp4 r0.x, a0, c8
bdaaaaaaaaaaacacaaaaaaoeaaaaaaaaajaaaaoeabaaaaaa dp4 r0.y, a0, c9
bdaaaaaaacaaabaebeaaaaoeabaaaaaaabaaaaoeacaaaaaa dp4 v2.x, c20, r1
bdaaaaaaadaaacaeaaaaaaoeacaaaaaabbaaaaoeabaaaaaa dp4 v3.y, r0, c17
bdaaaaaaadaaabaeaaaaaaoeacaaaaaabaaaaaoeabaaaaaa dp4 v3.x, r0, c16
aaaaaaaaabaaahaeabaaaaoeaaaaaaaaaaaaaaaaaaaaaaaa mov v1.xyz, a1
aaaaaaaaaaaaadaeadaaaaoeaaaaaaaaaaaaaaaaaaaaaaaa mov v0.xy, a3
